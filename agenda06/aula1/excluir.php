...
margin">EXLUIR - ID: <?php echo " " . $_GET['id'] ?> </h1>
...
grey" disabled value="<?php echo $_GET['nome'] ?>">
            ...
            <input name="txtApelido" class="w3-input w3-border w3-
grey" disabled value="<?php echo $_GET['apelido'] ?>">
            <br>
            <label class="w3-text-teal" style="font-weight: bold;">Email</label>
            <input name="txtEmail" class="w3-input w3-border w3-
grey" disabled value="<?php echo $_GET['email'] ?>">
            <br>
