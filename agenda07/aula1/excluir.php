...
<body class="w3-black">
    <!-- Botão de Cancelar ajustado e posicionado corretamente conforme a Imagem 11 -->
    <a href="index.php" class="w3-display-topmiddle w3-red w3-center w3-padding w3-button" style="text-decoration:none;">
        ...
        <p style="font-weight:bold; margin:0;">CANCELAR EXCLUSÃO</p>
    </a>
    ...
    <div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
        ...
        <form action="excluirAction.php" class="w3-container" method="post">
            ...
            <input name="txtPreco" class="w3-input w3-grey w3-border" disabled value="<?php echo $_GET['preco'] ?>">
            <br>
            <label class="w3-text-indigo" style="font-weight: bold;">Quantidade</label>
            <input name="txtQtd" class="w3-input w3-grey w3-border" disabled value="<?php echo $_GET['quantidade'] ?>">
            <br>
